...
The engine is generic and follows the `libmagic` specification. While it can theoretically parse any rule, it currently has only been tested for PDFs and ELF binaries.
